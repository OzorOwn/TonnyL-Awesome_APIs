...
### Development
+ [Agent Gateway](https://api-catalog-three.vercel.app/docs) - Unified API gateway providing 40+ services for AI agents including web scraping, screenshots, code execution, crypto prices, file storage, and more. Free tier with 200 credits.
